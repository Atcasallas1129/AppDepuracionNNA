<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="consultaHistoricoNNA.aspx.cs" Inherits="AppDepuracionNNA.Modulo.consultaHistoricoNNA" %>
                ...
                <div class="panel panel-default" style="margin-top:10px;">
                    <div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-4">
                                    <div class="form-group-sm">
                                        <label>Documento Victima</label>
                                        <asp:TextBox ID="txtDocumentoVictima" runat="server" CssClass="input-sm form-control"></asp:TextBox>
                                    </div>
                            </div>
                            <div class="col-md-4">
                    ...
                    <asp:GridView ID="dgvHistoricoNna" runat="server" DataKeyNames="IdRegistro" CssClass="table table-hover table-condensed" AllowPaging="True" DataSourceID="LinqDataSource" AutoGenerateColumns="False" PageSize="25" BorderStyle="None" BorderWidth="1px" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="dgvHistoricoNna_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Detalle">
                                <ItemTemplate>
                                    <asp:Button ID="Button1" runat="server" CommandName="Select" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CssClass="btn btn-xs btn-success" Height="30px" Text="Detalle" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    <asp:LinqDataSource ID="LinqDataSource" runat="server" OnSelecting="linqDataSourceDatos_Selecting"></asp:LinqDataSource>
                </div>
            </div>
        </div>
    </div>
